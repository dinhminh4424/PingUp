    ...
    <div className="min-h-screen relative bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex flex-col gap-3">
          {dummyConnectionsData.map((conver) => {
            return (
              <div
                key={conver._id}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-500">@{conver.username}</p>
                  <p className="text-sm text-gray-600">{conver.bio}</p>
                </div>
                ...
                <div className="flex flex-col gap-2 mt-4">
                  ...
                  <button
                    onClick={() => navigate(`/profile/${conver._id}`)}
                    className="size-10 flex items-center justify-center text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 transition cursor-pointer gap-1"
                  >
