      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">Đang tải dữ liệu thời gian thực...</p>
          </div>
        </div>
    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900 rounded-xl p-6 text-center">
          <h2 className="text-lg font-semibold text-red-700 dark:text-red-400 mb-2">Đã xảy ra lỗi</h2>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-400 px-3 py-1.5 rounded-full text-xs font-semibold border border-emerald-200/50 dark:border-emerald-800/30 w-fit">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="hover:shadow-md transition duration-200 border-l-4 border-l-blue-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Lượng tài khoản đã đăng ký</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition duration-200 border-l-4 border-l-indigo-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.totalPosts.toLocaleString("vi-VN")}</div>
        ...
        <Card className="hover:shadow-md transition duration-200 border-l-4 border-l-violet-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Tin nhắn gửi đi</CardTitle>
            <div className="p-2 bg-violet-50 dark:bg-violet-950/30 text-violet-600 dark:text-violet-400 rounded-lg">
              <MessageSquare className="size-4" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.totalMessages.toLocaleString("vi-VN")}</div>
            <p className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
        ...
        <Card className="hover:shadow-md transition duration-200 border-l-4 border-l-rose-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Tổng lượt thích</CardTitle>
            <div className="p-2 bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-400 rounded-lg">
              <Heart className="size-4" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.totalLikes.toLocaleString("vi-VN")}</div>
            <p className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
