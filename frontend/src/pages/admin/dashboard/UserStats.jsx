    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="hover:shadow-md transition">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data?.totalUsers?.toLocaleString("vi-VN") || 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Lượng tài khoản đăng ký hệ thống
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data?.activeUsers?.toLocaleString("vi-VN") || 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Đang trực tuyến:{" "}
        ...
        <Card className="hover:shadow-md transition">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600 dark:text-red-400">
              {data?.blockedUsers?.toLocaleString("vi-VN") || 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Tài khoản bị tạm khóa/ngắt hoạt động
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data?.verifiedUsers?.toLocaleString("vi-VN") || 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="bg-gradient-to-br from-teal-50/50 to-emerald-50/50 dark:from-teal-900/10 dark:to-emerald-900/10 border-teal-100 dark:border-teal-900/40 hover:shadow-md transition">
        ...
        <Card className="bg-gradient-to-br from-amber-50/50 to-orange-50/50 dark:from-amber-900/10 dark:to-orange-900/10 border-amber-100 dark:border-amber-900/40 hover:shadow-md transition">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-900/10 dark:to-indigo-900/10 border-blue-100 dark:border-blue-900/40">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
        ...
        <Card className="bg-gradient-to-br from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/10 dark:to-purple-900/10 border-indigo-100 dark:border-indigo-900/40">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
        ...
        <Card className="bg-gradient-to-br from-purple-50/50 to-pink-50/50 dark:from-purple-900/10 dark:to-pink-900/10 border-purple-100 dark:border-purple-900/40">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
      ...
      <Card>
        <CardHeader className="flex flex-col md:flex-row justify-between md:items-center gap-4 pb-2">
          <div>
            ...
            <CardDescription>
              Chọn chu kỳ thời gian phù hợp để lọc dữ liệu
            </CardDescription>
          </div>
          ...
          <div className="h-[220px] w-full relative">
            {!data?.chart || data.chart.length === 0 ? (
              <div className="text-center w-full text-muted-foreground text-xs pt-20">
                Chưa có dữ liệu thống kê đăng ký
              </div>
            ) : (
              <ChartContainer
                config={{
