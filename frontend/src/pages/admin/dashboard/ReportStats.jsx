      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/50 pb-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">
            Thống kê Kiểm duyệt & Báo cáo
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Theo dõi, xử lý và phân tích các báo cáo nội dung vi phạm trên mạng
            xã hội
          </p>
        </div>
          ...
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-emerald-500 font-medium">
                +{summary.newReportsToday || 0} hôm nay
              </p>
            </div>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <h3 className="text-3xl font-extrabold text-slate-600 dark:text-slate-400">
                {summary.dismissedReports || 0}
              </h3>
              <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 pb-2 border-b border-border/50">
          <div>
            ...
            <CardDescription>
              Biến động lượng báo cáo gửi lên hệ thống
            </CardDescription>
          </div>
          ...
          <div className="h-full w-full">
            {!chart || chart.length === 0 ? (
              <div className="text-center w-full text-muted-foreground text-xs pt-20">
                Chưa có dữ liệu thống kê báo cáo vi phạm
              </div>
            ) : (
              <ChartContainer
                config={{
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              Phân loại lý do người dùng gửi báo cáo
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {!leaderboards.topReasons ||
            leaderboards.topReasons.length === 0 ? (
              <div className="text-center py-10 text-muted-foreground text-xs">
                Chưa có lý do báo cáo
              </div>
            ) : (
                ...
                <div key={idx} className="flex flex-col gap-1.5">
                  ...
                  <div className="w-full bg-gray-100 dark:bg-gray-800 h-2 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(item.count / (leaderboards.topReasons[0]?.count || 1)) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                  ...
                  <tbody>
                    {recentReports.map((report) => (
                      ...
                      >
                        <td className="py-3 flex items-center gap-2">
                          <Avatar className="h-6 w-6">
                            ...
                            <AvatarFallback className="text-[10px]">
                              {report.reporterId?.full_name?.charAt(0) || "U"}
                            </AvatarFallback>
                          </Avatar>
                        ...
                        <td className="py-3 text-muted-foreground max-w-[120px] truncate">
                          {report.reason}
                        </td>
