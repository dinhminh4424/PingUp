...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`w-60 xl:w-72 bg-white dark:bg-zinc-900 border-r border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-white flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen ? "translate-x-0 " : "max-sm:-translate-x-full"} transition-all duration-300 ease-in-out`}
    >
        ...
        {menuOpen && (
          <div className="absolute bottom-16 left-6 right-6 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-xl z-30 p-2 flex flex-col gap-1 animate-in fade-in slide-in-from-bottom-2 duration-150">
            ...
            <button
              ...
              className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-50 dark:hover:bg-zinc-900 transition w-full text-left text-sm font-medium text-gray-700 dark:text-zinc-300"
            >
